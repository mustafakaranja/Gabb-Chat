              ...
              <React.Fragment>
                <ListItem p={1} onClick={() => this.selectUser("chatRoom")}>
                  <Tag
                    ...
                    shadow="md"
                    variantColor={
                      this.state.activeItem === "chatRoom" ? "blue" : "orange"
                    }
                    roundedRight="md"
                    roundedLeft="full"
                    cursor="pointer"
                    position="relative"
                  >
                    <Avatar size="md" ml={-2} mr={2} />
                    <TagLabel>Gabb Room</TagLabel>
                    <Spinner
                      position="absolute"
                      right="0"
                      style={{
                        display:
                          ...
                          this.state.activeItem === "chatRoom"
                            ? "block"
                            : "none",
                      }}
                    />
                  ...
                  return user.uid !== this.props.userId ? (
                    ...
                    >
                      <Tag
                        ...
                        shadow="md"
                        variantColor={
                          this.state.activeItem === user.uid ? "blue" : "orange"
                        }
                        roundedRight="md"
                        roundedLeft="full"
                        cursor="pointer"
                      ...
                      >
                        ...
                        <Spinner
                          ...
                          style={{
                            display:
                              this.props.loadingData &&
                              this.state.activeItem === user.uid
                                ? "block"
                                : "none",
                          }}
                        />
